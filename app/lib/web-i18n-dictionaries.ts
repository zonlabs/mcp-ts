...
export const en = {
  ...
  welcomeMcpAssistant: "Welcome to LinkOS",
  ...
  featuredOnMcpAssistant: "Featured on LinkOS",
  ...
  apiKeysDescription: "LLM provider credentials and LinkOS access",
