...
export function ConsentActions() {
  ...
  const [activeAction, setActiveAction] = useState<"allow" | "cancel" | null>(null);
  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        ...
        variant="ghost"
      >
        {pending && activeAction === "cancel" ? <Spinner /> : "Cancel"}
      </Button>
    </div>
  );
}
