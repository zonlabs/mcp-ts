    ...
    [
      'classic',
      {
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl:
            'https://github.com/zonlabs/mcp-redis/tree/main/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/zonlabs/mcp-redis',
          position: 'right',
          ...
          items: [
            {
              ...
              href: 'https://github.com/zonlabs/mcp-redis/discussions',
            },
            {
              label: 'Report an Issue',
              href: 'https://github.com/zonlabs/mcp-redis/issues',
            },
          ],
        },
        {
          ...
          items: [
            {
              html: `
                <a href="https://github.com/zonlabs/mcp-redis" target="_blank" rel="noreferrer noopener" aria-label="GitHub" class="footer__link-item">
