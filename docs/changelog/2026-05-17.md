...
The tool approval flow now delivers a more consistent approval payload to apps that use the [React](/react) or [Vue](/vue) hooks. Annotation fields have been removed from tool definitions to simplify the [tool types](/reference/types).
