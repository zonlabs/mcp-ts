...
```typescript
import { useMcpApps } from '@mcp-ts/client/client/react';
...
```typescript
import { useAppHost } from '@mcp-ts/client/client/react';
...
```typescript
import { SSEClient } from '@mcp-ts/client/client';
