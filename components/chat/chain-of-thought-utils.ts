...
export function getNextSelectedThoughtMessageId(
  currentSelectedThoughtMessageId: string | null,
  clickedMessageId: string
): string | null {
  return currentSelectedThoughtMessageId === clickedMessageId ? null : clickedMessageId;
}
