...
describe("resolveMcpUsageServerUrl", () => {
  it("prefers a matching server identity and falls back to the session id", () => {
    const connections = [
      {
        sessionId: "assistant-session",
        serverId: "workflow-automation-engine",
    ...
    assert.equal(
      resolveMcpUsageServerUrl(
        { mcp_session_id: "assistant-session", server_id: "github-prod", server_name: "GitHub", app_key: "github" },
        connections
      ),
      "https://github.com"
    );
    assert.equal(
      resolveMcpUsageServerUrl(
        { mcp_session_id: "assistant-session", server_id: "workflow-automation-engine", server_name: "Workflow Automation Engine", app_key: null },
        connections
      ),
